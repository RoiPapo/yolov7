...
def detect_video(save_video=False, opt=None):
    ...
    save_video = not opt.nosave and not source.endswith('.txt')  # save inference images
        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            if len(det):
                ...
                for *xyxy, conf, cls in reversed(det):
                    ...
                    if save_video or view_img:  # Add bbox to image
...
def main():
    source_of_Video = "/home/roi/PycharmProjects/yolov7/computer-vision-ex1-3/P023_tissue2.wmv"
    parser = argparse.ArgumentParser()
    parser.add_argument('--weights', nargs='+', type=str, default='runs/train/old/exp41/weights/best.pt',
                        help='model.pt path(s)')
    parser.add_argument('--source', type=str, default=source_of_Video, help='source')  # file/folder, 0 for webcam
